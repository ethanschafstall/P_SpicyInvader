...
CREATE TABLE `t_arme` (
  ...
  PRIMARY KEY (`idArme`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8;
...
INSERT INTO `t_arme` VALUES (1,'Laser basique','Un laser standard avec une force modérée.',100,50,20),
(2,'Missile nucléaire','Arme très puissante capable de détruire plusieurs ennemis en une fois.',5000,500,1),
(3,'Canon à plasma','Tire des boules de plasma à haute température.',800,200,5),(4,'Bouclier magnétique','Une arme défensive qui repousse les projectiles ennemis.',1200,0,10),
(5,'Bombes à fragmentation','Explose en plusieurs mini-bombes après le lancement.',1500,250,3),(6,'Rayon gelant','Immobilise temporairement les ennemis en les gelant sur place.',700,25,15),
(7,'Torpilles cosmiques','Des torpilles qui suivent les ennemis.',1200,150,5),(8,'Désintégrateur','Rayon puissant qui vaporise l’ennemi instantanément.',2500,400,2),
(9,'Ondes soniques','Émet des ondes sonores déstabilisantes.',550,60,10),(10,'Électro-pulse','Une arme qui lance des impulsions électriques paralysantes.',950,80,7),
(11,'Lance-roquettes quantique','Tire des roquettes avec une technologie quantique avancée.',2000,280,4),(12,'Vortex noir','Crée un mini trou noir qui aspire tout sur son passage.',5000,1000,1),
(13,'Bouclier énergétique','Un bouclier qui absorbe les attaques ennemies pendant un court laps de temps.',1500,0,3),(14,'Champ de force magnétique','Repousse les projectiles ennemis proches.',1200,0,5),
(15,'Drone protecteur','Un drone qui vole autour du joueur et intercepte les tirs ennemis.',2000,0,1),(16,'Miroir réfléchissant',"Renvoie les projectiles ennemis dans leur direction d'origine.",1800,0,4),
(17,'Générateur de brouillard','Crée un brouillard épais, rendant le joueur moins visible pour une courte durée.',1000,0,3),(18,'Capsule temporelle',"Ralentit le temps autour du joueur, permettant d\'éviter plus facilement les attaques.",2500,0,2),
(19,'Distorsionneur spatial',"Téléporte le joueur dans une position aléatoire à l\'écran pour échapper aux attaques.",2200,0,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
